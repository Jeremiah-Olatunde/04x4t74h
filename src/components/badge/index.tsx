...
const base = tw`whitespace-nowrap w-full flex items-center justify-center font-sora font-semibold capitalize cursor-pointer border-1 border-transparent`
